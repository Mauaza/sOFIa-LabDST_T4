...
\begin{figure}[H]
\centering
\subfloat[$t\approx6$ s.]{\includegraphics[width=0.47\linewidth]{s1}\label{fig:sim-a}}
\hfill
\subfloat[$t\approx10$ s.]{\includegraphics[width=0.47\linewidth]{s2}\label{fig:sim-b}}\\
\subfloat[$t\approx15$ s.]{\includegraphics[width=0.47\linewidth]{s3}\label{fig:sim-c}}
\hfill
\subfloat[$t\approx18$ s.]{\includegraphics[width=0.47\linewidth]{s4}\label{fig:sim-d}}
\caption{MATLAB microtest of the 16-unit array following the circular target.}
...
The source code, simulation files, and supporting material developed for the sOFIa project are available at:
\url{https://github.com/Mauaza/sOFIa-LabDST_T4/tree/main}
